...
public class LongestCommonSubsequence {
	...
	public static List<String> allLCS(String s1, String s2) {
		...
		int[][] map = new int[arr1.length+1][arr2.length+1];
		char[][] trace = new char[arr1.length+1][arr2.length+1]; // "U", up; "L", left; "B", could go up or left; "T", topleft corner.
	...
	public static void backtraceLCS(char[][] trace, int row, int col, String suffix, String s1, String s2, List<String> list) {
		if(row == 0 || col == 0) {
