...
/**
 * Implements the {@link Dictionary} interface as a red-black tree from Chapter
 * 13 of <i>Introduction to Algorithms</i>, Second edition. Objects inserted
 * into a red-black tree must implement the <code>Comparable</code> interface.
 */
...
public class RedBlackTree extends BinarySearchTree {
	...
	/**
	 * Inner class for a red-black tree node. Extends a binary search tree node with
	 * an additional color field.
	 */
	protected class Node extends BinarySearchTree.Node {
		...
		/**
		 * Initializes a node with the data, makes other pointers nil, and makes the
		 * node red.
		 *
		 * @param data
		...
		/**
		 * Returns the <code>data</code> instance variable of this node and this node's
		 * color as a <code>String</code>.
		 */
	...
	/**
	 * Set the sentinel <code>nil</code> to a given node, and make the sentinel
	 * black.
	 *
	 * @param node
	...
	/**
	 * Creates a red-black tree with just a <code>nil</code>, which is the root.
	 */
	public RedBlackTree() {
		setNil(new Node(-1));
		root = nil;
	 ...
	 * @throws DeleteSentinelException
	 *             if there is an attempt to delete the sentinel <code>nil</code>.
	 * @throws ClassCastException
	 *             if <code>node</code> does not reference a <code>Node</code>
	 *             object.
	 */
	 ...
	 *
	 * @param x
	 *            Node at which there may be a violation.
	 */
	...
	/**
	 * Returns the number of black nodes from a given node down to any leaf. The
	 * value should be the same for all paths.
	 *
	 * @param z
	 *            The node.
	 * @throws BlackHeightException
	 *             if the number of black nodes on a path from the left child down
	 *             to a leaf differs from the number of black nodes on a path from
	 *             the right child down to a leaf.
	 */
	...
	/**
	 * Returns the number of black nodes from the root down to any leaf. The value
